...
hl.config({
  general = {
    ...
    col              = {
      active_border   = { colors = { "rgba(0, 0, 0, 1)", "rgba(255, 255, 255, 1)", "rgba(255, 215, 0, 1)", "rgba(255, 255, 255, 1)", "rgba(0, 0, 0, 1)" }, angle = 20 },
...
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = prod(6), bezier = "default" }) -- Ref https://wiki.hypr.land/Configuring/Basics/Workspace-Rules/
...
hl.bind(mainMod .. " + F1", hl.dsp.exec_cmd("pulseaudio"))
