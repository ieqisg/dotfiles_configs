...
vim.keymap.set("n", "<C-1>", ":BufferLineGoToBuffer 1<CR>", { silent = true })
vim.keymap.set("n", "<C-2>", ":BufferLineGoToBuffer 2<CR>", { silent = true })
vim.keymap.set("n", "<C-3>", ":BufferLineGoToBuffer 3<CR>", { silent = true })
vim.keymap.set("n", "<C-4>", ":BufferLineGoToBuffer 4<CR>", { silent = true })
vim.keymap.set("n", "<C-5>", ":BufferLineGoToBuffer 5<CR>", { silent = true })
vim.keymap.set("n", "<C-6>", ":BufferLineGoToBuffer 6<CR>", { silent = true })
vim.keymap.set("n", "<C-7>", ":BufferLineGoToBuffer 7<CR>", { silent = true })
vim.keymap.set("n", "<C-8>", ":BufferLineGoToBuffer 8<CR>", { silent = true })
vim.keymap.set("n", "<C-9>", ":BufferLineGoToBuffer 9<CR>", { silent = true })
